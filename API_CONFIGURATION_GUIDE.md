...
export const API_CONFIG = {
  SERVER_IP: '192.168.1.38',     // Change this when server IP changes
  SERVER_PORT: '3000',
  BASE_URL: 'http://192.168.1.38:3000/api',
...
```typescript
SERVER_IP: '192.168.1.38',  // Change this line to the new IP
```
...
1. **Environment-based configuration:**
   ...
   const SERVER_IP = IS_PRODUCTION ? 'api.example.com' : '192.168.1.38';
   ```
...
$url = "http://192.168.1.38:3000/api/technician/login"
