...
export const API_CONFIG = {
  SERVER_IP: '10.198.136.226',     // Change this when server IP changes
  SERVER_PORT: '3000',
  BASE_URL: 'http://10.198.136.226:3000/api',
...
```typescript
SERVER_IP: '10.198.136.226',  // Change this line to the new IP
```
...
1. **Environment-based configuration:**
   ...
   const SERVER_IP = IS_PRODUCTION ? 'api.example.com' : '10.198.136.226';
   ```
...
$url = "http://10.198.136.226:3000/api/technician/login"
